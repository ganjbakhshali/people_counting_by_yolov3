...
parser.add_argument('--video', help='Path to video file.',default="inputvideos/cut.mp4")
...
frames_path="inputvideos/MOT17/train/MOT17-04-DPM/img1/"
...
for i in range(len(files)):
    ...
    cv.imwrite(f"outputframes/{i}.jpg",frame)
